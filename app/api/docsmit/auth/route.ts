...
export async function GET() {
    try {
        ...
        const payload = {
            ...
            password: 'f5a23e5066e4552f0484f56d0a0f6831151bd829cfdd895dea1ce0524d76a44e4bfa47f04b43cdc08027f9a66bab0766cf8ef316dfeb92d7e8c09035d7c3a822',
            softwareID,
        }

        const data = await postWithResponse(
